...
import SeoHead from "./Components/SeoHead"; // ✅ Nuevo import para SEO
...
export default function ContactForm() {
  ...
  return (
    ...
    >
      {/* ✅ SEO dinámico */}
      <SeoHead
        title={t.seo?.title || "Contacto | Boating Adventures Miami"}
        description={
          t.seo?.description ||
          "Consultas y reservas de paseos en barco por Miami. Contactanos para tu experiencia en el agua."
        }
        keywords={t.seo?.keywords || "contacto, reservas, paseos en barco, Miami"}
      />
